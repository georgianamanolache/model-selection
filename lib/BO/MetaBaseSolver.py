...
class MetaBaseSolver(object):

    def __init__(self, acquisition_funcs=None, models=None,
                 maximize_funcs=None, task=None, save_dir=None):
        """
        ...
        Parameters
        ----------
        acquisition_funcs: BaseAcquisitionFunction Object list
            The acquisition functions which will be maximized for each model.
        models: ModelObject
            Models (i.e. GaussianProcess, RandomForest) that models our current
        ...
        task: TaskObject
            ...
            space.
        maximize_funcs: MaximizerObject list
            Optimization methods that is used to maximize the acquisition
